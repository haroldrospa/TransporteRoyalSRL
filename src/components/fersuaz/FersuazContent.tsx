...
import FersuazHeader from './FersuazHeader';
import LAMLoadingStateOptimized from '@/components/lam/LAMLoadingStateOptimized';

// Lazy load heavy components - reuse LAM components where possible
...
const FersuazNoDataCard = lazy(() => import('./FersuazNoDataCard'));
...
import { useFersuazContent } from '@/hooks/useFersuazContent';

const FersuazContent = memo(() => {
  const { user } = useAuth();
...
FersuazContent.displayName = 'FersuazContent';

export default FersuazContent;
