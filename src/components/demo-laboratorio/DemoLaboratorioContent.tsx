...
import DemoLaboratorioHeader from './DemoLaboratorioHeader';
...
import { useDemoLabContent } from '@/hooks/useDemoLabContent';

const DemoLaboratorioContent = memo(() => {
  const { user } = useAuth();
  ...
  if (loading) {
    return <LAMLoadingStateOptimized laboratorio="Laboratorio Demo" />;
  }

  return (
    <div className="space-y-4 animate-fade-in">
      <DemoLaboratorioHeader 
...
DemoLaboratorioContent.displayName = 'DemoLaboratorioContent';

export default DemoLaboratorioContent;
