...
import TaapharmaceuticaHeader from './TaapharmaceuticaHeader';
...
const FersuazNoDataCard = lazy(() => import('@/components/fersuaz/FersuazNoDataCard'));
...
import { useTaapharmaceuticaContent } from '@/hooks/useTaapharmaceuticaContent';

const TaapharmaceuticaContent = memo(() => {
  const { user } = useAuth();
...
TaapharmaceuticaContent.displayName = 'TaapharmaceuticaContent';

export default TaapharmaceuticaContent;
